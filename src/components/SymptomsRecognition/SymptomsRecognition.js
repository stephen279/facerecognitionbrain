		...
		<div className="center ma">
			<div className="f3 lh-copy">
				...
				<article id="mycard" class="center mw5 mw6-ns br3 hidden ba b--black-10 mv4">
					<h1 id="symptoms_confidence" class="f1 bg-near-white br2 br--top black-60 mv0 pv1 ph3" />
					<div class="pa2 bt b--black-10">
						<p id="symptoms_result" class="f6 f5-ns lh-copy measure">
							{' '}
							Result will show here and who can treat.
						</p>
				...
				<article id="mycard" class="center mw5 mw6-ns br3 hidden ba b--black-10 mv4">
					<h1 id="symptoms_confidence_1" class="f1 bg-near-white br2 br--top black-60 mv0 pv1 ph3" />
					<div class="pa2 bt b--black-10">
						<p id="symptoms_result_1" class="f6 f5-ns lh-copy measure">
							{' '}
							Result 2 will show here.
						</p>
